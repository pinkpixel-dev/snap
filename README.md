...
* **AI neural upscaling:** Enhance image resolution 2× or 4× using Real-ESRGAN with GPU acceleration and memory-bounded tiled processing. Run a second pass on the result to go further, up to an 8000px long edge.
